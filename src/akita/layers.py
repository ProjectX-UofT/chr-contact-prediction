...
class ConcatDist2D(nn.Module):
    ...
    def __init__(self):
        ...
        dists = torch.tensor([[[[abs(i - j)] for i in range(512)] for j in range(512)]])
        dist_matrix = dists.float() / (512 - 1)
...
class Conv1dBlock(nn.Module):
    ...
    def __init__(
        ...
        layers = [
            ...
            nn.BatchNorm1d(out_channels, momentum=0.07)
        ]
...
class Conv2dBlock(nn.Module):
    ...
    def __init__(
        ...
        layers = [
            ...
            nn.BatchNorm2d(out_channels, momentum=0.07)
        ]
